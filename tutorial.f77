...
<><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>
     ...
     de simples precisão. A operação a4=a3 não dará a precisão pois a4 não tem o 
...
C       av11 --> real 8 matriz de duas  componentes, ....
...
ia1=           3
 ...
 Operações ja construídas no FORTRAN:
   ...
   Existem  as funções já embutidas na compilação de seu programa,
...
mas uma busca simples na internet te dará a lista completa das mesmas.
...
Atencao: Por razões históricas: write(6,*)  e o mesmo que write(*,*)
	 a unidade 5 tambem não pode  ser usada 
Exemplo:
<>>><><><><><><><><><><><><><><><><><>
C	programa6.f
        dimension a(20)
...
_____________________ A saida do programa sera em fort.3  _____________
...
<><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>>
	vamos dar um outro exemplo de um programa com os vários 
